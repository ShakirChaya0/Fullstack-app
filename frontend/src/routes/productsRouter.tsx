...
const FoodsListed = lazy(() => import("../features/Products/components/foods/FoodsList"))
const DrinksListed = lazy(() => import("../features/Products/components/drinks/DrinksList"))
