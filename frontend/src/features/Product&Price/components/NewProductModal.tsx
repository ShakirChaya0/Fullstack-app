...
export function NewProductModal() {
    ...
    const { saveProductMutation } = useMutationProductRegistration({
        newProduct,
        setNewProduct,
        setProductType,
        setModalError,
        ...
        >
            ...
            <DialogContent>
                <div className="flex flex-col">
                    ...
                    >
                        Complete los siguientes campos para crear un nuevo
                        producto en su menú.
                    </Typography>
                                ...
                                onChange={(e) => {
                                    ...
                                    setNewProduct((prev) => {
                                        ...
                                        if (
                                            ...
                                            //Validando que tenga un formato correcto
                                            const newValue =
