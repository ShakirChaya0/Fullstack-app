                ...
                <div className="md:border flex flex-col py-4 md:border-gray-300 md:shadow-2xl w-full max-w-3xl md:rounded-2xl">
                    ...
                    <div className="flex flex-col gap-4 p-3">
                        {order.lineasPedido.map((lp) => (
                            <div key={lp.lineNumber} className="flex flex-col gap-2 border border-gray-300 rounded-xl shadow-sm p-3">
                                <div className="flex justify-between items-center">
                                    <div className="flex flex-col max-w-[200px]">
                                        <span className="font-semibold">{lp.producto._name}</span>
                                        <span className="text-sm text-gray-600 pr-1">{lp.producto._description}</span>
                                    ...
                                    <div className="text-right">
                                        ...
                                        <p className="text-sm font-bold">Estado: {lp.estado}</p>
                        ...
                        <div className="flex flex-row gap-2 justify-between">
                            <label className="font-bold text-gray-700">Cantidad de comensales:</label>
                        ...
                        <div className="flex justify-between mt-4">
                            ...
                            <button
                                className={`m-auto py-2 px-4 rounded-lg shadow-lg text-white font-bold transition-all ${order.estado === 'Completado'
