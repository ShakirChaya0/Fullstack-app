...
export function OrderList() {
    ...
    return (
        <>
            <button
                onClick={handleClick}
                className={`group hidden md:flex fixed top-43 -right-18 
            ...
            >
                    ...
                    <div className="flex justify-center">
                        <button className="cursor-pointer">
                            <svg
                                ...
                                viewBox="0 0 24 24"
                                fill="currentColor"
                                className={`size-6 md:hidden sm:block ${isOpen ? "rotate-180" : ""}`}
                            >
                                <path
                                    fillRule="evenodd"
                ...
                {order.lineasPedido?.length === 0 && (
                    <>
                        ...
                        />
                        <p className="text-center">Pedido Vacío</p>
                    </>
                )}
                {order.lineasPedido?.length !== 0 && (
                    <>
                                ...
                                <NavLink
                                    to={
                                        isValidModification === "true"
                                            ? "/Cliente/Menu/ModificarPedido"
                                            : "/Cliente/Menu/RealizarPedido"
                                    }
                                >
                                    <button
                                        className="w-full py-3 cursor-pointer bg-orange-500
