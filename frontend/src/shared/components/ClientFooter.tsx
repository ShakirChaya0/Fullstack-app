...
export function ClientFooter() {
    ...
    const quickLinks = [
        ...
        },
        {
            ...
            url: "/Cliente/Reserva/Historial",
            icon: <HistoryIcon sx={{ fontSize: 16, mr: 0.5 }} />,
            end: true,
        },
    ];
        ...
        >
            ...
            >
                ...
                <Box>
                    ...
                    >
                        Vive una experiencia gastronómica excepcional. Reserva
                        fácilmente y descubre el mejor sabor con nuestro
