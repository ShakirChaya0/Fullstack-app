...
const navLinks = [
    ...
    {
        label: "Sugerencias",
        path: "/Cocina/Sugerencias",
        icon: <LightbulbIcon sx={{ fontSize: 16, mr: 0.5 }} />,
        end: true,
    },
    {
        label: "Pedidos",
        ...
        >
            ...
            >
                ...
                <Box>
                    ...
                    >
                        Plataforma de cocina diseñada para optimizar la gestión
                        de pedidos y la sugerencias de platos. Facilita la
                        coordinación de tu equipo en la cocina y mejora la
                        eficiencia diaria.
                    </Typography>
                </Box>
