...
export const ClientSchema = z.object({
    nombreUsuario: z.string()
        .min(1, 'El nombre de usuario del cliente es obligatorio')
        .max(50, 'El nombre de usuario del cliente no puede exceder los 50 caracteres'),

    contrasenia: z.string().nonempty({message: 'La contraseña es obligatoria'}).min(6, 'La contraseña del cliente debe tener al menos 6 caracteres').max(100, 'La contraseña del cliente no puede exceder los 100 caracteres'),
    ...
    nombre: z.string()
        ...
        .max(50, 'El nombre del cliente no puede exceder los 50 caracteres'), 

    apellido: z.string()
        .min(1, 'El apellido del cliente es obligatorio')
        .max(50, 'El apellido del cliente no puede exceder los 50 caracteres'),
