...
export function WaiterRouter () {
    ...
    waiterRouter.get("/id/:idMozo", RoleMiddleware(["Administrador"]), (req, res, next) => { waiterController.getWaiterById(req, res, next) });
    ...
    waiterRouter.patch("/id/:idMozo", RoleMiddleware(["Administrador", "Mozo"]), (req, res, next) => { waiterController.modifyWaiter(req, res, next) });
