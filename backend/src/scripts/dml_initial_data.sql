...
INSERT INTO public."Producto" ("idProducto", "nombre", "descripcion", "estado", "tipo", "esVegetariana", "esVegana", "esSinGluten", "esAlcoholica") VALUES
(1, 'Bife de Chorizo', 'Corte de 400g', 'Disponible', 'Plato Principal', false, false, true, NULL),
(2, 'Ojo de Bife', 'Corte premium 450g', 'Disponible', 'Plato Principal', false, false, true, NULL),
(3, 'Papas Fritas Tradicionales', 'Porción grande', 'Disponible', 'Entrada', true, true, true, NULL),
(4, 'Papas con Cheddar', 'Cheddar y verdeo', 'Disponible', 'Entrada', true, false, true, NULL),
(5, 'Milanesa Napolitana', 'Para compartir', 'Disponible', 'Plato Principal', false, false, false, NULL),
(6, 'Pasta Penne Rigate', 'Salsa bolognesa', 'Disponible', 'Plato Principal', false, false, false, NULL),
(7, 'Ensalada César', 'Pollo, croutons y aderezo', 'Disponible', 'Plato Principal', false, false, false, NULL),
(8, 'Pizza Muzarella', '8 porciones', 'Disponible', 'Plato Principal', true, false, false, NULL),
(9, 'Pizza Pepperoni', 'Estilo New York', 'Disponible', 'Plato Principal', false, false, false, NULL),
(10, 'Hamburguesa Classic', 'Medallón 180g', 'Disponible', 'Plato Principal', false, false, false, NULL),
(11, 'Hamburguesa Veggie', 'Lentejas y quínoa', 'Disponible', 'Plato Principal', true, true, false, NULL),
(12, 'Empanada de Carne', 'Salteña frita', 'Disponible', 'Entrada', false, false, false, NULL),
(13, 'Empanada de Humita', 'Maíz y queso blanco', 'Disponible', 'Entrada', true, false, false, NULL),
(14, 'Provoleta', 'A las brasas', 'Disponible', 'Entrada', true, false, true, NULL),
(15, 'Rabas', 'Anillos de calamar', 'Disponible', 'Entrada', false, false, false, NULL),
(16, 'Bastones de Muzarella', 'Con salsa pomodoro', 'Disponible', 'Entrada', true, false, false, NULL),
(17, 'Sorrentinos de Jamon y Queso', 'Salsa mixta', 'Disponible', 'Plato Principal', false, false, false, NULL),
(18, 'Ravioles de Espinaca', 'Salsa blanca', 'Disponible', 'Plato Principal', true, false, false, NULL),
(19, 'Lomo al Strogonoff', 'Con arroz blanco', 'Disponible', 'Plato Principal', false, false, true, NULL),
(20, 'Pollo al Verdeo', 'Con papas noisette', 'Disponible', 'Plato Principal', false, false, true, NULL),
(21, 'Salmon Rosado', 'A la plancha', 'Disponible', 'Plato Principal', false, false, true, NULL),
(22, 'Arroz con Mariscos', 'Paella individual', 'Disponible', 'Plato Principal', false, false, true, NULL),
(23, 'Risotto de Hongos', 'Trufa blanca', 'Disponible', 'Plato Principal', true, false, true, NULL),
(24, 'Taco Vegano', '3 unidades soja texturizada', 'Disponible', 'Entrada', true, true, false, NULL),
(25, 'Nachos con Guacamole', 'Casero y totopos de maíz', 'Disponible', 'Entrada', true, true, true, NULL),
(26, 'Sopa del Dia', 'Crema de calabaza', 'Disponible', 'Entrada', true, true, true, NULL),
(27, 'Tarta de Verduras', 'Mix estacional Sin TACC', 'Disponible', 'Plato Principal', true, false, true, NULL),
(28, 'Wok de Vegetales', 'Salsa de soja y tofu', 'Disponible', 'Plato Principal', true, true, false, NULL),
(29, 'Flan Casero', 'Con dulce de leche', 'Disponible', 'Postre', true, false, true, NULL),
(30, 'Tiramisu', 'Receta italiana', 'Disponible', 'Postre', true, false, false, NULL),
(31, 'Chocotorta', 'Clásico argentino', 'Disponible', 'Postre', true, false, false, NULL),
(32, 'Helado 2 bochas', 'Vainilla y chocolate', 'Disponible', 'Postre', true, false, true, NULL),
(33, 'Brownie con Helado', 'Chocolate amargo', 'Disponible', 'Postre', true, false, false, NULL),
...
-- Carga de Bebidas (Incluye Alcoholicas y No Alcoholicas)
INSERT INTO public."Producto" ("idProducto", "nombre", "descripcion", "estado", "esAlcoholica", "tipo", "esVegetariana", "esVegana", "esSinGluten") VALUES
(41, 'Agua Mineral', '500ml', 'Disponible', false, NULL, NULL, NULL, NULL),
(42, 'Agua con Gas', '500ml', 'Disponible', false, NULL, NULL, NULL, NULL),
(43, 'Coca Cola', '350ml', 'Disponible', false, NULL, NULL, NULL, NULL),
(44, 'Sprite', '350ml', 'Disponible', false, NULL, NULL, NULL, NULL),
(45, 'Fanta', '350ml', 'Disponible', false, NULL, NULL, NULL, NULL),
(46, 'Cerveza Quilmes', 'Chopp 500ml', 'Disponible', true, NULL, NULL, NULL, NULL),
(47, 'Cerveza Patagonia', 'IPA 500ml', 'Disponible', true, NULL, NULL, NULL, NULL),
(48, 'Vino Malbec', 'Copa 250ml', 'Disponible', true, NULL, NULL, NULL, NULL),
(49, 'Vino Chardonnay', 'Copa 250ml', 'Disponible', true, NULL, NULL, NULL, NULL),
(50, 'Limonada', 'Con menta y jengibre', 'Disponible', false, NULL, NULL, NULL, NULL),
(51, 'Jugo de Naranja', 'Exprimido natural', 'Disponible', false, NULL, NULL, NULL, NULL),
(52, 'Fernet Branca', 'Con Coca Cola', 'Disponible', true, NULL, NULL, NULL, NULL),
(53, 'Gin Tonic', 'Con rodaja de pepino', 'Disponible', true, NULL, NULL, NULL, NULL),
(54, 'Cafe Espresso', 'Grano molido', 'Disponible', false, NULL, NULL, NULL, NULL),
(55, 'Te de Hierbas', 'Variedades', 'Disponible', false, NULL, NULL, NULL, NULL);
