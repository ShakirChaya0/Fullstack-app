-- SCRIPT DE CARGA ADAPTADO A USUARIOS ESPECÍFICOS
...
('1f8c7221-450a-4556-b163-3678e4b67f6f', 'Mozo2', 'barraganseba@gamil.com', '$2b$10$IrhqH7f5.jgIIzvASEVwAe9IW1yaSZU4t80qkdoxja2UjaSBu3WuC', 'Mozo'),
...
-- 5. RESERVAS, PEDIDOS Y PAGOS (BLOQUE CORREGIDO)
DO $$
DECLARE
    cliente_id UUID;
    mozo_id UUID;
BEGIN
    FOR i IN 1..10 LOOP
        ...
        -- 10 Pedidos Pagados (SE AGREGÓ LA COLUMNA "observaciones")
...
SELECT setval(pg_get_serial_sequence('public."Reserva"', 'idReserva'), 10);
